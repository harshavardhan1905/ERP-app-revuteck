            ...
            <!-- Container -->
                <div class="kt-container-fixed">
                    <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
                        ...
                        <div class="flex items-center gap-2 text-sm font-normal text-secondary-foreground">
                            Permission  Trash bin Restore or Delete permanently
                        </div>
                    </div>
                ...
                <div class="grid gap-5 lg:gap-7.5">
                    ...
                    <div class="kt-card-header flex flex-wrap items-center justify-between gap-2 shadow-none">
                       <a href="/permissions" class="kt-btn kt-btn-light kt-btn-sm flex items-center gap-2">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="text-sm font-medium text-secondary-foreground">
                                {{ \Carbon\Carbon::parse($permission->deleted_at)->format('d M, Y') }}
                            </span>
                        </td>
                        ...
                        <td class="text-right">
                            <div class="flex justify-end gap-2">
                                ...
                                <form action="/permissions/{{ $permission->id }}/restore" method="POST">
                                    @csrf
                    ...
                    <tr>
                        <td colspan="6" class="text-center py-10 text-muted-foreground">
                            No permissions found in the trash.
                        </td>
                    </tr>
                    @endforelse
                    </tbody>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('.trigger-delete-modal').forEach(button => {
            button.addEventListener('click', function() {
                permissionIdToDelete = this.getAttribute('data-id');
                const permissionName = this.getAttribute('data-name');

                document.getElementById('delete_modal_text').innerText =
                    `Are you sure you want to permanently delete "${permissionName}"?`;
        ...
        document.getElementById('confirm_delete_btn').addEventListener('click', function() {
            if (permissionIdToDelete) {
                ...
                form.method = 'POST';
                form.action = `/permissions/${permissionIdToDelete}/force-delete`;
