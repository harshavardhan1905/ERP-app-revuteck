...
<html class="h-full" data-kt-theme="true" data-kt-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  ...
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo1/public-profile/profiles/modal" rel="canonical"/>
  ...
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo1/public-profile/profiles/modal" property="og:url"/>
  ...
  <div class="flex grow">
   ...
   <div class="kt-wrapper flex grow flex-col">
     ...
     <div class="bg-center bg-cover bg-no-repeat hero-bg">
      ...
      <div class="kt-container-fixed">
       <div class="flex flex-col items-center gap-2 lg:gap-3.5 py-4 lg:pt-5 lg:pb-10">
        <img class="rounded-full border-3 border-green-500 size-[100px] shrink-0" data-kt-modal-toggle="#modal_profile" src="assets/media/avatars/300-1.png">
         <div class="flex items-center gap-1.5">
	...
	.dark .modal-bg {
     ...
     <div class="kt-modal kt-modal-open:!flex py-10" data-kt-modal="true" data-kt-modal-disable-scroll="false" id="modal_profile">
       ...
       <div class="kt-modal-header rounded-t-lg p-0 border-0 relative min-h-80 flex flex-col items-stretch justify-end bg-center bg-cover bg-no-repeat mb-7 modal-bg">
        <div class="flex flex-col justify-end border-b-0 grow px-9 bg-linear-to-t from-light from-3% to-transparent">
         ...
         <div class="flex justify-center mb-5">
          <img class="rounded-full border-3 border-green-500 max-h-[100px]" src="assets/media/avatars/300-1.png">
          </img>
         </div>
          ...
          <div class="flex items-center flex-col">
           ...
           <div class="flex flex-wrap justify-center gap-1 lg:gap-3 text-sm">
            <div class="flex gap-1 items-center">
             <i class="ki-filled ki-abstract text-muted-foreground text-base">
             </i>
            ...
            <div class="flex gap-1 items-center">
             <i class="ki-filled ki-sms text-muted-foreground text-base">
             </i>
