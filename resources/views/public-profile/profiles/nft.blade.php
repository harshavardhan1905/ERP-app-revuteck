...
<html class="h-full" data-kt-theme="true" data-kt-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  ...
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo1/public-profile/profiles/nft" rel="canonical"/>
  ...
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo1/public-profile/profiles/nft" property="og:url"/>
          ...
          <div class="kt-card-content">
           <div class="grid gap-y-5">
            <div class="flex align-start gap-2">
             <i class="ki-filled ki-xmr text-2xl leading-none text-primary">
             </i>
             <div class="flex flex-col gap-2">
              <span class="text-2xl font-semibold text-mono leading-none tracking-tight">
               302.97 XMR
              </span>
              <span class="text-sm font-medium text-secondary-foreground">
               $42,074.81
         ...
         <div class="kt-card">
          ...
          <div class="kt-card-content">
           <div class="flex flex-col gap-3.5 mb-3.5">
            <div class="flex items-center gap-2.5">
             <span class="text-sm text-secondary-foreground min-w-14 xl:min-w-24 shrink-0">
              Joined:
             </span>
         ...
         <div class="kt-card">
          ...
          <div class="kt-card-content">
           <div class="grid gap-y-3.5">
            <div class="flex items-center gap-2.5">
             <i class="ki-filled ki-dribbble text-base text-muted-foreground">
             </i>
            ...
            <div class="flex items-center gap-2.5">
             <i class="ki-filled ki-twitter text-base text-muted-foreground">
             </i>
             <a class="text-sm leading-none text-mono hover:text-primary" href="#">
              jennynft
             </a>
         ...
         <div class="flex flex-col gap-5 lg:gap-7.5">
          <div class="kt-card">
           <div class="kt-card-header">
            ...
            <a class="kt-link kt-link-underlined kt-link-dashed" href="html/demo1/network/user-cards/author.html">
             View All
            </a>
           </div>
           <div class="kt-card-content p-5 lg:p-7.5 lg:pb-7">
            <div class="flex gap-5 kt-scrollable-x">
             <div class="kt-card shadow-none border-0 mb-5">
              <div class="rounded-t-xl w-[280px] h-[240px] bg-cover bg-center" style="background-image: url('assets/media/images/600x600/1.jpg')">
              </div>
              <div class="kt-card-border kt-card-rounded-b px-3.5 pt-5 pb-3.5">
               <div class="pb-6">
                <a class="font-media/images/600x600/ block font-medium text-mono hover:text-primary text-base leading-4 mb-2" href="#">
                 Artistic Expressions
                </a>
               ...
               <div class="grid grid-cols-2 items-center">
                <div class="flex flex-col gap-2">
                 ...
                 <div class="flex items-center gap-1">
                  <i class="ki-filled ki-xmr text-lg text-primary leading-none">
                  </i>
                  <span class="text-sm font-semibold text-mono leading-none tracking-tight">
                   3.2 XMR
                  </span>
                 </div>
                </div>
