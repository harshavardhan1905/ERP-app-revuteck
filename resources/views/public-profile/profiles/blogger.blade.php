...
<html class="h-full" data-kt-theme="true" data-kt-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  ...
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo1/public-profile/profiles/blogger" rel="canonical"/>
  ...
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo1/public-profile/profiles/blogger" property="og:url"/>
        ...
        <img class="rounded-full border-3 border-green-500 size-[100px] shrink-0" src="assets/media/avatars/300-1.png">
         ...
         <div class="flex flex-wrap justify-center gap-1 lg:gap-4.5 text-sm">
          <div class="flex gap-1.25 items-center">
           <i class="ki-filled ki-dribbble text-muted-foreground text-sm">
           </i>
           <span class="text-secondary-foreground font-medium">
            KeenThemes
           </span>
        ...
        <div class="flex flex-col gap-5 lg:gap-7.5">
         ...
         <div class="kt-card">
          <div class="kt-card-header">
           ...
           <a class="kt-link kt-link-underlined kt-link-dashed" href="html/demo1/public-profile/profiles/feeds.html">
            View All
           </a>
          </div>
          <div class="kt-card-content p-5 lg:p-7.5 lg:pb-7">
           <div class="flex flex-no-wrap kt-scrollable-x gap-5">
            <div class="kt-card shadow-none w-[280px] border-0 mb-4">
             ...
             <div class="kt-card-border kt-card-rounded-b grid gap-1.5 px-5 py-4">
              <a class="font-medium text-primary text-sm hover:text-primary" href="#">
               Software
              </a>
              <a class="font-medium text-mono text-lg leading-6 mb-1.5 hover:text-primary" href="#">
               Maximizing Efficiency with Modern Software
              </a>
              <time class="flex items-center gap-1.5 text-sm text-secondary-foreground leading-none">
               <i class="ki-filled ki-time text-lg text-muted-foreground">
               </i>
               4 hours ago
              </time>
             </div>
           ...
           <div class="flex flex-col gap-5">
            <div class="border-s-2 border-primary">
             <div class="flex gap-3 items-center ps-3 mb-0.5">
              ...
              <div class="rounded-full w-1.5 h-1.5 bg-input gap-1.5">
              </div>
             ...
             <p class="text-sm text-foreground leading-5.5 ps-3">
              Experienced UI/UX designer seeking new opportunities.
             </p>
            </div>
            <div class="border-s-2 border-primary">
            ...
            <div class="border-s-2 border-yellow-500 dark:border-yellow-950">
             <div class="flex gap-3 items-center ps-3 mb-0.5">
              <span class="text-xs text-secondary-foreground">
               4 Feb, 24
              </span>
            ...
            <div class="border-s-2 border-green-500">
             <div class="flex gap-3 items-center ps-3 mb-0.5">
              <span class="text-xs text-secondary-foreground">
               17 Mar, 24
              </span>
            ...
            <div class="border-s-2 border-danger">
             <div class="flex gap-3 items-center ps-3 mb-0.5">
              <span class="text-xs text-secondary-foreground">
               9 Apr, 24
              </span>
