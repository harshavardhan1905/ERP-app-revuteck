...
<html class="h-full" data-kt-theme="true" data-kt-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  ...
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo1/public-profile/profiles/feeds" rel="canonical"/>
  ...
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo1/public-profile/profiles/feeds" property="og:url"/>
        ...
        <div class="kt-menu-accordion gap-1 ps-[10px] relative before:absolute before:start-[20px] before:top-0 before:bottom-0 before:border-s before:border-border">
         <div class="kt-menu-item here show" data-kt-menu-item-toggle="accordion" data-kt-menu-item-trigger="click">
          ...
          <div class="kt-menu-accordion gap-1 relative before:absolute before:start-[32px] ps-[22px] before:top-0 before:bottom-0 before:border-s before:border-border">
           ...
           <div class="kt-menu-item here show flex-col-reverse" data-kt-menu-item-toggle="accordion" data-kt-menu-item-trigger="click">
     ...
     <div class="kt-container-fixed">
      <div class="flex items-center flex-wrap md:flex-nowrap lg:items-end justify-between border-b border-b-border gap-3 lg:gap-6 mb-5 lg:mb-10">
         ...
         <div class="kt-menu gap-3" data-kt-menu="true">
          <div class="kt-menu-item border-b-2 border-b-transparent kt-menu-item-active:border-b-primary kt-menu-item-here:border-b-primary here" data-kt-menu-item-overflow="true" data-kt-menu-item-placement="bottom-start" data-kt-menu-item-placement-rtl="bottom-end" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click|lg:hover">
           ...
           <div class="kt-menu-dropdown kt-menu-default py-2 min-w-[200px]">
            ...
            <div class="kt-menu-item here" data-kt-menu-item-offset="-10px, 0" data-kt-menu-item-placement="right-start" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click|lg:hover">
       ...
       <div class="flex items-center justify-end grow lg:grow-0 lg:pb-4 gap-2.5 mb-3 lg:mb-0">
        <button class="kt-btn kt-btn-primary" data-kt-dropdown-toggle="true">
         <i class="ki-filled ki-users">
         </i>
         Connect
        </button>
       ...
       <div class="col-span-2">
        <div class="flex flex-col gap-5 lg:gap-7.5">
         <div class="kt-card">
          ...
          <div>
           <div class="flex flex-col sm:flex-row items-stretch sm:items-center flex-wrap gap-2.5 border-input border-t border-b border-dashed py-3 mb-4 mx-7.5" data-kt-tabs="true">
            <button class="active group kt-btn shadow-none bg-transparent px-3 text-secondary-foreground hover:text-primary kt-tab-active:bg-primary/10 kt-tab-active:border-primary/10 kt-tab-active:text-primary" data-kt-tab-toggle="#post_1_comments">
             <i class="ki-filled ki-message-text text-muted-foreground group-hover:text-primary kt-tab-active:text-primary">
             </i>
             2 Comments
            </button>
            <button class="group kt-btn shadow-none bg-transparent px-3 text-secondary-foreground hover:text-primary kt-tab-active:bg-primary/10 kt-tab-active:border-primary/10 kt-tab-active:text-primary" data-kt-tab-toggle="#post_1_likes">
             <i class="ki-filled ki-heart text-muted-foreground group-hover:text-primary kt-tab-active:text-primary">
             </i>
             47k Likes
            </button>
            <button class="group kt-btn shadow-none bg-transparent px-3 text-secondary-foreground hover:text-primary kt-tab-active:bg-primary/10 kt-tab-active:border-primary/10 kt-tab-active:text-primary" data-kt-tab-toggle="#post_1_saves">
             <i class="ki-filled ki-archive-tick text-muted-foreground group-hover:text-primary kt-tab-active:text-primary">
             </i>
             900 Saves
            </button>
           </div>
           <div id="post_1_comments">
            <div class="grid gap-2 lg:gap-5 p-7.5 pt-0">
             <div class="flex items-start gap-2.5">
              ...
              <div class="grid gap-2.5 grow">
               ...
               <p class="text-sm text-foreground heading-5.5">
			...
			a great blog post in five simple steps that people will actually want to read. Ready?
             ...
             <div class="flex items-center gap-2.5">
              ...
              <div class="kt-input input-lg">
               <input placeholder="your comment.." type="text" value=""/>
               <button class="kt-btn kt-btn-icon kt-btn-ghost kt-btn-sm -me-1.5">
                <i class="ki-filled ki-picture">
                </i>
               </button>
              </div>
	...
	.dark .post-saves-bg {
		...
		margin-bottom: -4.5rem;
            ...
            <div class="text-center p-7.5 pt-5">
             ...
             <div class="text-xl font-medium text-mono text-center my-2">
              Access Restricted for this Option
             </div>
             <span class="text-sm text-secondary-foreground block mb-7.5">
         ...
         <div class="kt-card">
          ...
          <p class="mb-5 text-sm text-foreground leading-5.5 px-7.5">
		...
		cardboard box manufacturing company.” I feel your pain, I really do.
          ...
          <div>
           <div class="flex flex-col sm:flex-row items-stretch sm:items-center flex-wrap gap-2.5 border-input border-t border-b border-dashed py-3 mb-4 mx-7.5" data-kt-tabs="true">
            <button class="group kt-btn shadow-none bg-transparent px-3 text-secondary-foreground hover:text-primary kt-tab-active:bg-primary/10 kt-tab-active:border-primary/10 kt-tab-active:text-primary" data-kt-tab-toggle="#post_2_comments">
             <i class="ki-filled ki-message-text text-muted-foreground group-hover:text-primary kt-tab-active:text-primary">
             </i>
             2 Comments
            </button>
            <button class="group kt-btn shadow-none bg-transparent px-3 text-secondary-foreground hover:text-primary kt-tab-active:bg-primary/10 kt-tab-active:border-primary/10 kt-tab-active:text-primary" data-kt-tab-toggle="#post_2_likes">
             <i class="ki-filled ki-heart text-muted-foreground group-hover:text-primary kt-tab-active:text-primary">
             </i>
             24 Likes
            </button>
            <button class="active group kt-btn shadow-none bg-transparent px-3 text-secondary-foreground hover:text-primary kt-tab-active:bg-primary/10 kt-tab-active:border-primary/10 kt-tab-active:text-primary" data-kt-tab-toggle="#post_2_saves">
             <i class="ki-filled ki-archive-tick text-muted-foreground group-hover:text-primary kt-tab-active:text-primary">
             </i>
             16 Saves
            </button>
	...
	.dark .post-saves-bg {
		...
		margin-bottom: -4.5rem;
         ...
         <div class="kt-card">
          <div class="flex justify-between items-center mb-5 p-7.5 pb-0">
           <div class="flex items-center gap-3">
            <div class="flex items-center justify-center uppercase rounded-full size-[50px] shrink-0 bg-primary/10 text-primary">
          ...
          <p class="text-sm text-foreground leading-5.5 px-7.5">
		...
		you’d want to read – even if they relate to niche industries.
          ...
          <div>
           <div class="flex flex-col sm:flex-row items-stretch sm:items-center flex-wrap gap-2.5 border-input border-t border-b border-dashed py-3 mb-4 mx-7.5" data-kt-tabs="true">
            <button class="group kt-btn shadow-none bg-transparent px-3 text-secondary-foreground hover:text-primary kt-tab-active:bg-primary/10 kt-tab-active:border-primary/10 kt-tab-active:text-primary" data-kt-tab-toggle="#post_3_comments">
             <i class="ki-filled ki-message-text text-muted-foreground group-hover:text-primary kt-tab-active:text-primary">
             </i>
             27 Comments
            </button>
            <button class="active group kt-btn shadow-none bg-transparent px-3 text-secondary-foreground hover:text-primary kt-tab-active:bg-primary/10 kt-tab-active:border-primary/10 kt-tab-active:text-primary" data-kt-tab-toggle="#post_3_likes">
             <i class="ki-filled ki-heart text-muted-foreground group-hover:text-primary kt-tab-active:text-primary">
             </i>
             47k Likes
            </button>
            <button class="group kt-btn shadow-none bg-transparent px-3 text-secondary-foreground hover:text-primary kt-tab-active:bg-primary/10 kt-tab-active:border-primary/10 kt-tab-active:text-primary" data-kt-tab-toggle="#post_3_saves">
             <i class="ki-filled ki-archive-tick text-muted-foreground group-hover:text-primary kt-tab-active:text-primary">
             </i>
             900 Saves
            </button>
	...
	.dark .post-saves-bg {
		...
		margin-bottom: -4.5rem;
         ...
         <div class="kt-card">
          ...
          <p class="text-sm text-foreground leading-5.5 mb-5 px-7.5">
		...
		next, even if you don’t know anything about it.
          ...
          <div>
           <div class="flex flex-col sm:flex-row items-stretch sm:items-center flex-wrap gap-2.5 border-input border-t border-b border-dashed py-3 mb-4 mx-7.5" data-kt-tabs="true">
            <button class="active group kt-btn shadow-none bg-transparent px-3 text-secondary-foreground hover:text-primary kt-tab-active:bg-primary/10 kt-tab-active:border-primary/10 kt-tab-active:text-primary" data-kt-tab-toggle="#post_4_comments">
             <i class="ki-filled ki-message-text text-muted-foreground group-hover:text-primary kt-tab-active:text-primary">
             </i>
             2 Comments
            </button>
            <button class="group kt-btn shadow-none bg-transparent px-3 text-secondary-foreground hover:text-primary kt-tab-active:bg-primary/10 kt-tab-active:border-primary/10 kt-tab-active:text-primary" data-kt-tab-toggle="#post_4_likes">
             <i class="ki-filled ki-heart text-muted-foreground group-hover:text-primary kt-tab-active:text-primary">
             </i>
             47k Likes
            </button>
            <button class="group kt-btn shadow-none bg-transparent px-3 text-secondary-foreground hover:text-primary kt-tab-active:bg-primary/10 kt-tab-active:border-primary/10 kt-tab-active:text-primary" data-kt-tab-toggle="#post_4_saves">
             <i class="ki-filled ki-archive-tick text-muted-foreground group-hover:text-primary kt-tab-active:text-primary">
             </i>
             900 Saves
            </button>
