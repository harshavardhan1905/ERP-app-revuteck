...
<html class="h-full" data-kt-theme="true" data-kt-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  ...
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo1/public-profile/profiles/gamer" rel="canonical"/>
  ...
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo1/public-profile/profiles/gamer" property="og:url"/>
     ...
     <div class="bg-center bg-cover bg-no-repeat hero-bg">
      ...
      <div class="kt-container-fixed">
       <div class="flex flex-col items-center gap-2 lg:gap-3.5 py-4 lg:pt-5 lg:pb-10">
        <img class="rounded-full border-3 border-green-500 size-[100px] shrink-0" src="assets/media/avatars/300-27.png">
         <div class="flex items-center gap-1.5">
         ...
         <div class="flex flex-wrap justify-center gap-1 lg:gap-4.5 text-sm">
          ...
          <div class="flex gap-1.25 items-center">
           <i class="ki-filled ki-twitch text-muted-foreground text-sm">
           </i>
           <span class="text-secondary-foreground font-medium">
            floydgg
           </span>
          ...
          <div class="flex gap-1.25 items-center">
           <i class="ki-filled ki-ocus text-muted-foreground text-sm">
           </i>
           <a class="text-secondary-foreground font-medium hover:text-primary" href="mailto: Level 22">
            Level 22
           </a>
          </div>
         </div>
       ...
       <div class="col-span-1">
        <div class="flex flex-col gap-5 lg:gap-7.5">
         ...
         <div class="kt-card">
          ...
          <div class="kt-card-content pb-7 pt-4">
           <table class="kt-table-auto mb-1.5">
            <tbody>
             <tr>
              <td class="text-sm text-secondary-foreground pb-3 pe-4 lg:pe-12">
               Joined:
              </td>
        ...
        <div class="flex flex-col gap-5 lg:gap-7.5">
         <div class="kt-card">
          ...
          <div class="kt-card-content p-5 lg:p-7.5 lg:pb-7">
           <div class="flex flex-no-wrap kt-scrollable-x gap-5">
            <div class="kt-card shadow-none w-[285px] border-0">
             ...
             <div class="kt-card-border kt-card-rounded-b grid gap-6 px-5 pt-3.5 pb-3 mb-4">
              <div class="flex items-center gap-2.5">
               ...
               <div class="grid grid-cols-1 gap-0.5">
                ...
                <time class="flex items-center gap-1.5 text-xs text-secondary-foreground">
                 <div class="rounded-full w-1.5 h-1.5 bg-destructive gap-1.5">
                 </div>
            ...
            <div class="kt-card shadow-none w-[285px] border-0">
             ...
             <div class="kt-card-border kt-card-rounded-b grid gap-6 px-5 pt-3.5 pb-3 mb-4">
              ...
              <div class="grid gap-1.5 mb-0.5">
               <div class="kt-progress h-1.5 progress-primary">
                <div class="kt-progress-indicator" style="width: 42%">
                </div>
               </div>
               <div class="flex items-center place-content-between">
                <span class="text-secondary-foreground text-xs">
         ...
         <div class="kt-card">
          ...
          <div class="kt-card-content p-5 lg:p-7.5 lg:pb-7">
           <div class="flex flex-no-wrap kt-scrollable-x gap-5">
            <div class="kt-card shadow-none w-[280px] border-0">
             <img alt="" class="rounded-t-xl max-w-[280px] shrink-0" src="assets/media/images/600x600/10.jpg"/>
             <div class="kt-card-border kt-card-rounded-b grid gap-6 px-5 py-3.5 mb-4.5">
              <div class="flex items-center gap-2.5">
               ...
               <div class="grid grid-cols-1 gap-0.5">
                ...
                <span class="flex items-center gap-1.5 text-xs text-secondary-foreground">
             ...
             <div class="kt-card-border kt-card-rounded-b grid gap-6 px-5 py-3.5 mb-4.5">
              ...
              <div class="flex items-center place-content-between gap-2">
               <div class="flex -space-x-2">
                ...
                <div class="flex">
                 <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="assets/media/avatars/300-11.png"/>
                </div>
                <div class="flex">
                 <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="assets/media/avatars/300-20.png"/>
                </div>
                <div class="flex">
                 <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="assets/media/avatars/300-13.png"/>
                </div>
               </div>
               <span class="kt-badge kt-badge-sm kt-badge-warning kt-badge-outline">
                Rank 5
            ...
            <div class="kt-card shadow-none w-[280px] border-0">
             ...
             <div class="kt-card-border kt-card-rounded-b grid gap-6 px-5 py-3.5 mb-4.5">
              ...
              <div class="flex items-center place-content-between gap-2">
               <div class="flex -space-x-2">
                <div class="flex">
                 <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="assets/media/avatars/300-22.png"/>
                </div>
                <div class="flex">
             ...
             <div class="kt-card-border kt-card-rounded-b grid gap-6 px-5 py-3.5 mb-4.5">
              ...
              <div class="flex items-center place-content-between gap-2">
               <div class="flex -space-x-2">
                ...
                <div class="flex">
                 <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="assets/media/avatars/300-25.png"/>
                </div>
                <div class="flex">
                 <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="assets/media/avatars/300-26.png"/>
                </div>
                <div class="flex">
                 <span class="relative inline-flex items-center justify-center shrink-0 rounded-full ring-1 font-semibold leading-none text-2xs size-6 text-white ring-background bg-green-500">
                  +32
           ...
           <div class="flex flex-col">
            ...
            <div class="flex items-start relative">
             ...
             <div class="ps-2.5 mb-7 text-base grow">
              ...
              <div class="kt-card shadow-none p-4">
               <div class="flex flex-wrap gap-2.5">
                <i class="ki-filled ki-code text-lg text-violet-500">
                </i>
                <div class="flex flex-col gap-5 grow">
                 ...
                 <div class="flex flex-wrap gap-7.5">
                  ...
                  <div class="flex items-center gap-1.5">
                   ...
                   <div class="kt-progress kt-progress-success min-w-[120px]">
                    <div class="kt-progress-indicator" style="width: 80%">
                    </div>
                   </div>
                  </div>
                  <div class="flex items-center gap-1.5 lg:min-w-24 shrink-0 max-w-auto">
                   ...
                   <div class="flex -space-x-2">
                    ...
                    <div class="flex">
                     <span class="hover:z-5 relative inline-flex items-center justify-center shrink-0 rounded-full ring-1 font-semibold leading-none text-2xs size-7 text-primary-foreground ring-primary/10 bg-primary">
                      +24
                     </span>
                    </div>
                   </div>
