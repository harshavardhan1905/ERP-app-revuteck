...
<html class="h-full" data-kt-theme="true" data-kt-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  ...
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo1/public-profile/profiles/crm" rel="canonical"/>
  ...
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo1/public-profile/profiles/crm" property="og:url"/>
       ...
       <div class="col-span-1">
        <div class="grid gap-5 lg:gap-7.5">
         <div class="kt-card">
          ...
          <div class="kt-card-content pt-3.5 pb-3.5">
           <table class="kt-table-auto">
            <tbody>
             <tr>
              <td class="text-sm text-secondary-foreground pb-3 pe-4 lg:pe-8">
               Phone:
              </td>
         ...
         <div class="kt-card">
          ...
          <div class="kt-card-content pt-3.5 pb-1">
           <table class="kt-table-auto">
            <tbody>
             <tr>
              <td class="text-sm text-secondary-foreground pb-3.5 pe-4 lg:pe-6">
               customer_id:
              </td>
              <td class="text-sm text-mono pb-3">
               CUST567
          ...
          <div class="kt-card-footer justify-center">
           <a class="kt-link kt-link-underlined kt-link-dashed" href="html/demo1/network/user-table/store-clients.html">
            All Attributes
           </a>
          </div>
         </div>
         <div class="kt-card">
          ...
          <div class="kt-card-content">
           <div class="text-sm text-foreground leading-5.5 pb-5">
           ...
           <div class="flex flex-col flex-wrap gap-4">
            <div class="kt-input">
             ...
             <button class="kt-btn kt-btn-icon kt-btn-sm kt-btn-dim -me-1.5">
          ...
          <div class="kt-card-footer justify-center">
           <a class="kt-link kt-link-underlined kt-link-dashed" href="html/demo1/account/api-keys.html">
            Check API’s
           </a>
          </div>
         </div>
        ...
        <div class="flex flex-col gap-5 lg:gap-7.5">
         <div class="flex flex-col gap-5 lg:gap-7.5">
          <div class="kt-card">
            ...
            <table class="kt-table table-fixed">
             ...
             <tbody>
              <tr>
               ...
               <td class="text-end">
                <div class="kt-badge kt-badge-sm kt-badge-primary kt-badge-outline">
                 Ongoing
                </div>
               </td>
               <td class="text-sm text-foreground text-end">
              ...
              <tr>
               ...
               <td class="text-end">
                <div class="kt-badge kt-badge-sm kt-badge-destructive kt-badge-outline">
                 Canceled
                </div>
               </td>
               <td class="text-sm text-foreground text-end">
           ...
           <div class="kt-card-footer justify-center">
            <a class="kt-link kt-link-underlined kt-link-dashed" href="html/demo1/account/billing/history.html">
             All Deals
            </a>
           </div>
          </div>
            ...
            <div class="kt-card-content">
             <div class="grid gap-5">
              <div class="flex justify-between gap-3">
               <div class="flex items-center gap-2.5">
                <div class="flex items-center justify-center size-7.5 shrink-0 bg-accent/60 rounded-lg border border-input">
                 <i class="ki-filled ki-cheque text-base text-secondary-foreground">
                 </i>
                </div>
                <div class="flex flex-col gap-0.5">
