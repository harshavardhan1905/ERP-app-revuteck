...
<html class="h-full" data-kt-theme="true" data-kt-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  ...
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo1/public-profile/profiles/plain" rel="canonical"/>
  ...
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo1/public-profile/profiles/plain" property="og:url"/>
	...
	.dark .hero-bg {
     ...
     <div class="kt-container-fixed">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-7.5">
       ...
       <div class="col-span-2">
        <div class="kt-card">
         <div class="kt-card-content lg:py-9">
        ...
        <div class="kt-card pb-3 grow">
         ...
         <div class="kt-card-content pt-4">
          <div class="grid gap-2.5 mb-1">
           <div class="flex items-center gap-2.5">
            <span class="">
             <i class="ki-filled ki-abstract-41 text-lg text-muted-foreground">
             </i>
            </span>
           ...
           <div class="flex items-center gap-2.5">
            <span class="">
             <i class="ki-filled ki-crown-2 text-lg text-muted-foreground">
             </i>
            </span>
            <a class="text-mono hover:text-primary text-sm" href="#">
             Author Level 100
           ...
           <div class="flex items-center gap-2.5">
            <span class="">
             <i class="ki-filled ki-briefcase text-lg text-muted-foreground">
             </i>
            </span>
            <a class="text-mono hover:text-primary text-sm" href="#">
             UI/UX Desiger
           ...
           <div class="flex items-center gap-2.5">
            <span class="">
             <i class="ki-filled ki-icon text-lg text-muted-foreground">
             </i>
            </span>
            <a class="text-mono hover:text-primary text-sm" href="#">
       ...
       <div class="col-span-1 flex">
        <div class="kt-card grow">
         ...
         <div class="kt-card-footer justify-center lg:pb-9">
