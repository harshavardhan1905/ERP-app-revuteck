...
<html class="h-full" data-kt-theme="true" data-kt-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../">
  <title>
   Metronic - Tailwind CSS Welcome Message 2
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo1/authentication/welcome-message-2" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Welcome page with Canvas Confetti on modal show" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Welcome Message 2" name="twitter:title"/>
  <meta content="Welcome page with Canvas Confetti on modal show" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo1/authentication/welcome-message-2" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Welcome Message 2" property="og:title"/>
  <meta content="Welcome page with Canvas Confetti on modal show" property="og:description"/>
 ...
 <body class="antialiased flex h-full text-base text-foreground bg-background demo1 kt-sidebar-fixed kt-header-fixed">
  ...
  <div class="flex grow">
   ...
   <div class="kt-wrapper flex grow flex-col">
    ...
    <main class="grow pt-5" id="content" role="content">
        ...
        <div class="kt-scrollable-x-auto">
         <div class="kt-menu gap-3" data-kt-menu="true">
          ...
          <div class="kt-menu-item border-b-2 border-b-transparent kt-menu-item-active:border-b-primary kt-menu-item-here:border-b-primary">
           <a class="kt-menu-link gap-1.5 pb-2 lg:pb-4 px-2" href="html/demo1/account/integrations.html">
          ...
          <div class="kt-menu-item border-b-2 border-b-transparent kt-menu-item-active:border-b-primary kt-menu-item-here:border-b-primary">
           <a class="kt-menu-link gap-1.5 pb-2 lg:pb-4 px-2" href="html/demo1/account/notifications.html">
            <span class="kt-menu-title text-nowrap font-medium text-sm text-secondary-foreground kt-menu-item-active:text-primary kt-menu-item-active:font-semibold kt-menu-item-here:text-primary kt-menu-item-here:font-semibold kt-menu-item-show:text-primary kt-menu-link-hover:text-primary">
             Notifications
            </span>
           </a>
          ...
          <div class="kt-menu-item border-b-2 border-b-transparent kt-menu-item-active:border-b-primary kt-menu-item-here:border-b-primary">
           <a class="kt-menu-link gap-1.5 pb-2 lg:pb-4 px-2" href="html/demo1/account/api-keys.html">
            <span class="kt-menu-title text-nowrap font-medium text-sm text-secondary-foreground kt-menu-item-active:text-primary kt-menu-item-active:font-semibold kt-menu-item-here:text-primary kt-menu-item-here:font-semibold kt-menu-item-show:text-primary kt-menu-link-hover:text-primary">
             API Keys
            </span>
           </a>
      ...
      <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
       <div class="flex flex-col justify-center gap-2">
        ...
        <div class="flex items-center gap-2 text-sm font-medium">
         ...
         <a class="text-secondary-foreground hover:text-primary" href="mailto:jaytatum@ktstudio.com">
          jaytatum@ktstudio.com
         </a>
         <span class="size-0.75 bg-mono/50 rounded-full">
         </span>
         <a class="font-semibold link" href="#">
          Personal Info
         </a>
        </div>
       </div>
     ...
     <div class="kt-container-fixed">
      <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5 lg:gap-7.5">
       <div class="kt-card p-5 lg:p-7.5 lg:pt-7">
        <div class="flex flex-col gap-4">
         <div class="flex items-center justify-between gap-2">
          <i class="ki-filled ki-badge text-2xl text-primary">
          </i>
          <div class="kt-menu" data-kt-menu="true">
         ...
         <div class="flex flex-col gap-3">
          <a class="text-base font-medium leading-none text-mono hover:text-primary" href="html/demo1/account/members/team-info.html">
           Personal info
          </a>
       ...
       <div class="kt-card p-5 lg:p-7.5 lg:pt-7">
        <div class="flex flex-col gap-4">
         <div class="flex items-center justify-between gap-2">
          <i class="ki-filled ki-security-user text-2xl text-primary">
          </i>
          <div class="kt-menu" data-kt-menu="true">
           <div class="kt-menu-item" data-kt-menu-item-offset="0, 10px" data-kt-menu-item-placement="bottom-end" data-kt-menu-item-placement-rtl="bottom-start" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click">
            <button class="kt-menu-toggle kt-btn kt-btn-sm kt-btn-icon kt-btn-ghost">
         ...
         <div class="flex flex-col gap-3">
          <a class="text-base font-medium leading-none text-mono hover:text-primary" href="html/demo1/account/security/security-log.html">
           Login & Security
          </a>
          <span class="text-sm text-secondary-foreground leading-5">
       ...
       <div class="kt-card p-5 lg:p-7.5 lg:pt-7">
        <div class="flex flex-col gap-4">
         <div class="flex items-center justify-between gap-2">
          <i class="ki-filled ki-cheque text-2xl text-primary">
          </i>
          <div class="kt-menu" data-kt-menu="true">
           <div class="kt-menu-item" data-kt-menu-item-offset="0, 10px" data-kt-menu-item-placement="bottom-end" data-kt-menu-item-placement-rtl="bottom-start" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click">
            <button class="kt-menu-toggle kt-btn kt-btn-sm kt-btn-icon kt-btn-ghost">
         ...
         <div class="flex flex-col gap-3">
          <a class="text-base font-medium leading-none text-mono hover:text-primary" href="html/demo1/account/billing/basic.html">
           Billing & Payments
          </a>
          <span class="text-sm text-secondary-foreground leading-5">
       ...
       <div class="kt-card p-5 lg:p-7.5 lg:pt-7">
        <div class="flex flex-col gap-4">
         <div class="flex items-center justify-between gap-2">
          <i class="ki-filled ki-notification-on text-2xl text-primary">
          </i>
          <div class="kt-menu" data-kt-menu="true">
           <div class="kt-menu-item" data-kt-menu-item-offset="0, 10px" data-kt-menu-item-placement="bottom-end" data-kt-menu-item-placement-rtl="bottom-start" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click">
            <button class="kt-menu-toggle kt-btn kt-btn-sm kt-btn-icon kt-btn-ghost">
         ...
         <div class="flex flex-col gap-3">
          <a class="text-base font-medium leading-none text-mono hover:text-primary" href="html/demo1/account/notifications.html">
           Notifications
          </a>
          <span class="text-sm text-secondary-foreground leading-5">
       ...
       <div class="kt-card p-5 lg:p-7.5 lg:pt-7">
        <div class="flex flex-col gap-4">
         <div class="flex items-center justify-between gap-2">
          <i class="ki-filled ki-dropbox text-2xl text-primary">
          </i>
          <div class="kt-menu" data-kt-menu="true">
           <div class="kt-menu-item" data-kt-menu-item-offset="0, 10px" data-kt-menu-item-placement="bottom-end" data-kt-menu-item-placement-rtl="bottom-start" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click">
            <button class="kt-menu-toggle kt-btn kt-btn-sm kt-btn-icon kt-btn-ghost">
         ...
         <div class="flex flex-col gap-3">
          <a class="text-base font-medium leading-none text-mono hover:text-primary" href="html/demo1/account/integrations.html">
           Integrations
          </a>
          <span class="text-sm text-secondary-foreground leading-5">
       ...
       <div class="kt-card p-5 lg:p-7.5 lg:pt-7">
        <div class="flex flex-col gap-4">
         <div class="flex items-center justify-between gap-2">
          <i class="ki-filled ki-user text-2xl text-primary">
          </i>
          <div class="kt-menu" data-kt-menu="true">
           <div class="kt-menu-item" data-kt-menu-item-offset="0, 10px" data-kt-menu-item-placement="bottom-end" data-kt-menu-item-placement-rtl="bottom-start" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click">
            <button class="kt-menu-toggle kt-btn kt-btn-sm kt-btn-icon kt-btn-ghost">
         ...
         <div class="flex flex-col gap-3">
          <a class="text-base font-medium leading-none text-mono hover:text-primary" href="html/demo1/account/members/roles.html">
           Members, Teams & Roles
          </a>
          <span class="text-sm text-secondary-foreground leading-5">
       ...
       <div class="kt-card p-5 lg:p-7.5 lg:pt-7">
        <div class="flex flex-col gap-4">
         <div class="flex items-center justify-between gap-2">
          <i class="ki-filled ki-key-square text-2xl text-primary">
          </i>
          <div class="kt-menu" data-kt-menu="true">
           <div class="kt-menu-item" data-kt-menu-item-offset="0, 10px" data-kt-menu-item-placement="bottom-end" data-kt-menu-item-placement-rtl="bottom-start" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click">
            <button class="kt-menu-toggle kt-btn kt-btn-sm kt-btn-icon kt-btn-ghost">
         ...
         <div class="flex flex-col gap-3">
          <a class="text-base font-medium leading-none text-mono hover:text-primary" href="html/demo1/account/api-keys.html">
           API Keys
          </a>
          <span class="text-sm text-secondary-foreground leading-5">
       ...
       <div class="kt-card p-5 lg:p-7.5 lg:pt-7">
        <div class="flex flex-col gap-4">
         <div class="flex items-center justify-between gap-2">
          <i class="ki-filled ki-mouse-square text-2xl text-primary">
          </i>
          <div class="kt-menu" data-kt-menu="true">
           <div class="kt-menu-item" data-kt-menu-item-offset="0, 10px" data-kt-menu-item-placement="bottom-end" data-kt-menu-item-placement-rtl="bottom-start" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click">
            <button class="kt-menu-toggle kt-btn kt-btn-sm kt-btn-icon kt-btn-ghost">
         ...
         <div class="flex flex-col gap-3">
          <a class="text-base font-medium leading-none text-mono hover:text-primary" href="html/demo1/account/appearance.html">
           Appearance
          </a>
          <span class="text-sm text-secondary-foreground leading-5">
       ...
       <div class="kt-card p-5 lg:p-7.5 lg:pt-7">
        <div class="flex flex-col gap-4">
         <div class="flex items-center justify-between gap-2">
          <i class="ki-filled ki-desktop-mobile text-2xl text-primary">
          </i>
          <div class="kt-menu" data-kt-menu="true">
           <div class="kt-menu-item" data-kt-menu-item-offset="0, 10px" data-kt-menu-item-placement="bottom-end" data-kt-menu-item-placement-rtl="bottom-start" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click">
            <button class="kt-menu-toggle kt-btn kt-btn-sm kt-btn-icon kt-btn-ghost">
         ...
         <div class="flex flex-col gap-3">
          <a class="text-base font-medium leading-none text-mono hover:text-primary" href="html/demo1.html">
           Devices
          </a>
          <span class="text-sm text-secondary-foreground leading-5">
       ...
       <div class="kt-card p-5 lg:p-7.5 lg:pt-7">
        <div class="flex flex-col gap-4">
         <div class="flex items-center justify-between gap-2">
          <i class="ki-filled ki-color-swatch text-2xl text-primary">
          </i>
          <div class="kt-menu" data-kt-menu="true">
           <div class="kt-menu-item" data-kt-menu-item-offset="0, 10px" data-kt-menu-item-placement="bottom-end" data-kt-menu-item-placement-rtl="bottom-start" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click">
            <button class="kt-menu-toggle kt-btn kt-btn-sm kt-btn-icon kt-btn-ghost">
         ...
         <div class="flex flex-col gap-3">
          <a class="text-base font-medium leading-none text-mono hover:text-primary" href="html/demo1/account/invite-a-friend.html">
           Brand
          </a>
          <span class="text-sm text-secondary-foreground leading-5">
       ...
       <div class="kt-card p-5 lg:p-7.5 lg:pt-7">
        <div class="flex flex-col gap-4">
         <div class="flex items-center justify-between gap-2">
          <i class="ki-filled ki-chart-line-star text-2xl text-primary">
          </i>
          <div class="kt-menu" data-kt-menu="true">
           <div class="kt-menu-item" data-kt-menu-item-offset="0, 10px" data-kt-menu-item-placement="bottom-end" data-kt-menu-item-placement-rtl="bottom-start" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click">
            <button class="kt-menu-toggle kt-btn kt-btn-sm kt-btn-icon kt-btn-ghost">
         ...
         <div class="flex flex-col gap-3">
          <a class="text-base font-medium leading-none text-mono hover:text-primary" href="html/demo1/account/activity.html">
           Activity
          </a>
          <span class="text-sm text-secondary-foreground leading-5">
     ...
     <!-- End of Container -->
     <div class="kt-modal kt-modal-center" data-kt-modal="true" id="modal_welcome_confetti">
      <div class="kt-modal-content max-w-[500px] w-full">
       ...
       <div class="kt-modal-body flex flex-col items-center pt-0 pb-10">
        ...
        <div class="flex flex-col items-center gap-2 mb-2">
         <button class="kt-btn kt-btn-primary" id="welcome_confetti_btn" type="button">
          Fire confetti
         </button>
         <a class="kt-btn kt-btn-outline flex justify-center" href="html/demo1.html">
          Show me around
         </a>
        </div>
        <a class="text-sm font-medium text-secondary-foreground hover:text-primary py-3" href="html/demo1.html">
         Skip the tour
        </a>
       </div>
      </div>
  ...
  <script src="assets/vendors/canvas-confetti/canvas-confetti.min.js">
  </script>
  <script src="assets/js/widgets/welcome-confetti.js">
  </script>
