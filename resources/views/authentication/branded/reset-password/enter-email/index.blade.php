...
<html class="h-full" data-kt-theme="true" data-kt-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../../../">
  ...
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo1/authentication/branded/reset-password/enter-email/index.html" rel="canonical"/>
  ...
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo1/authentication/branded/reset-password/enter-email/index.html" property="og:url"/>
   ...
   <div class="flex justify-center items-center p-8 lg:p-10 order-2 lg:order-1">
    <div class="kt-card max-w-[370px] w-full">
     <form action="#" class="kt-card-content flex flex-col gap-5 p-10" id="reset_password_enter_email_form" method="post">
      ...
      <a class="kt-btn kt-btn-primary flex justify-center grow" href="html/demo1/authentication/branded/reset-password/check-email.html">
       Continue
