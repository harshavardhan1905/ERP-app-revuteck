...
<html class="h-full" data-kt-theme="true" data-kt-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  ...
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo1/authentication/branded/2fa" rel="canonical"/>
  ...
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo1/authentication/branded/2fa" property="og:url"/>
    ...
    <div class="kt-card max-w-[380px] w-full" id="2fa_form">
     <form action="#" class="kt-card-content flex flex-col gap-5 p-10" method="post">
      ...
      <div class="flex items-center justify-center mb-2">
       ...
       <a class="text-2sm kt-link" href="html/demo1/authentication/branded/sign-in.html">
        Resend
       </a>
      </div>
