...
<html class="h-full" data-kt-theme="true" data-kt-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  ...
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo1/authentication/classic/check-email" rel="canonical"/>
  ...
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo1/authentication/classic/check-email" property="og:url"/>
   ...
   <div class="kt-card max-w-[440px] w-full">
    <div action="#" class="kt-card-content p-10" id="check_email_form" method="post">
     ...
     <div class="flex items-center justify-center gap-1 text-2sm">
      ...
      <a class="font-medium kt-link" href="html/demo1/authentication/classic/sign-in.html">
       Resend
      </a>
     </div>
    </div>
