...
<html class="h-full" data-kt-theme="true" data-kt-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../../">
  ...
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo1/authentication/classic/sign-up/index.html" rel="canonical"/>
  ...
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo1/authentication/classic/sign-up/index.html" property="og:url"/>
    ...
    <form action="#" class="kt-card-content flex flex-col gap-5 p-10" id="sign_up_form" method="post">
     <div class="text-center mb-2.5">
      ...
      <div class="flex items-center justify-center">
       ...
       <a class="text-sm link" href="html/demo1/authentication/classic/sign-in.html">
        Sign In
       </a>
      </div>
     </div>
